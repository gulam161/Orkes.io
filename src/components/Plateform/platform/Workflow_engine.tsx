...
const Workflow_engine: React.FC<Workflow_engineProps> = () => {
  return (
    <section className="mx-auto my-12 flex w-[100%] h-[350px] rounded-xl grid_shaddow bg-gray-100 relative overflow-hidden">
      <img
        src={Platform_Page_Workflow_left}
        alt={Platform_Page_Workflow_left}
        className="absolute w-[320px] top-auto bottom-auto left-[-5%] right-auto"
      />

      <div className="text-center flex flex-col justify-center gap-4 relative z-10 px-40 tracking-wide">
      ...
      <img
        ...
        className="absolute w-[320px] top-auto bottom-auto right-[-5%] left-auto"
      />
    </section>
  );
};
